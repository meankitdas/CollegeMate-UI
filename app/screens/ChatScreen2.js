// ----------------------NOT USING THIS--------------------ONLY FOR IDEA PURPOSES----------------------------->
// ----------------------NOT USING THIS--------------------ONLY FOR IDEA PURPOSES----------------------------->
// ----------------------NOT USING THIS--------------------ONLY FOR IDEA PURPOSES----------------------------->
// ----------------------NOT USING THIS--------------------ONLY FOR IDEA PURPOSES----------------------------->
// ----------------------NOT USING THIS--------------------ONLY FOR IDEA PURPOSES----------------------------->
    ...
    navigation.setOptions({
      ...
      headerLeft: () => (
        <View style={styles.headerLeft}>
          ...
          >
            <AppText style={styles.name}>Ankit</AppText>
...
// ----------------------NOT USING THIS--------------------ONLY FOR IDEA PURPOSES----------------------------->
      ...
      headerRight: () => (
        ...
        >
          ...
          <MaterialIcons name="delete-outline" size={30} color="#000" />
        </TouchableOpacity>
      ),
    });
  }, []);
